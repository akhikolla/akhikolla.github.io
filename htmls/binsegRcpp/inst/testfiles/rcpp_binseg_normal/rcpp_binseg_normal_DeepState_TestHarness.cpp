...
TEST(binsegRcpp_deepstate_test,rcpp_binseg_normal_test){
  ...
  qs::c_qsave(data_vec,"/home/akhila/akhikolla.github.io/packages-folders/binsegRcpp/inst/testfiles/rcpp_binseg_normal/inputs/data_vec.qs",
		"high", "zstd", 1, 15, true, 1);
  std::cout << "data_vec values: "<< data_vec << std::endl;
  IntegerVector kmax(1);
  kmax[0]  = RcppDeepState_int();
  qs::c_qsave(kmax,"/home/akhila/akhikolla.github.io/packages-folders/binsegRcpp/inst/testfiles/rcpp_binseg_normal/inputs/kmax.qs",
		"high", "zstd", 1, 15, true, 1);
